...
#Jablonowski-Reed TC test using simple surface fluxes and PBL mixing
# plus GFDL microphysics.
# This script demonstrates stretching using the new do_cube_transform
#  option, so tile 6 isn't "upside down"
# Ideally the solo_core could write out the grid mosaic files
#  it creates, acting as a separate make_hgrid.
